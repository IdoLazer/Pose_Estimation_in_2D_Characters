...
#     'Lower Torso' : [0.9961946980917455, 0.08715574274765817, 0.6972459419812653, -0.08715574274765817, 0.9961946980917455, 7.969557584733964],
...
CANONICAL_BIAS_DICT = {  # Here we assume a skeleton structure so layers are affected by each other
    'Lower Torso': [0.9961946980917455, 0.08715574274765817, 0.01089446784345727 * (ImageGenerator.IMAGE_SIZE / 2),
